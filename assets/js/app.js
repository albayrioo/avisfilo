    ...
    <article class="vehicle-card reveal group relative rounded-[30px] overflow-hidden border border-red-100/80 bg-white shadow-[0_22px_80px_rgba(15,23,42,0.08)]" style="transition-delay:${index%6*70}ms">
      ...
      <div class="relative p-6 md:p-7">
        ...
        <div class="grid grid-cols-2 gap-3">
          ...
          <a href="${telHref(CONFIG.callPhone)}" class="action-btn call-btn pulse-call">
...
function applyContactInfo() {
  ...
  document.getElementById('header-phone-link').textContent = CONFIG.displayCallPhone;
  document.getElementById('header-phone-link').href = telHref(CONFIG.callPhone);
  document.getElementById('mobile-phone-link').innerHTML = `<i class="fas fa-phone-alt mr-2"></i>${CONFIG.displayCallPhone}`;
  document.getElementById('mobile-phone-link').href = telHref(CONFIG.callPhone);
  document.getElementById('contact-phone-link').textContent = CONFIG.displayCallPhone;
  document.getElementById('contact-phone-link').href = telHref(CONFIG.callPhone);
  document.getElementById('contact-whatsapp-link').textContent = CONFIG.displayWhatsappPhone;
  document.getElementById('contact-whatsapp-link').href = waHref(CONFIG.whatsappBaseMessage);
  document.getElementById('floating-support-link').href = telHref(CONFIG.callPhone);
